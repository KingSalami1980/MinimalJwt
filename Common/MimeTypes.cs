namespace MinimalJwt.Common
{
    public static class MimeTypes
    {
        public static class Application
        {
            ...
            public const string OctetStream2 = "application/octet-streamn";
            ...
            public const string Word2003 = "application/msword";
            public const string Word2007Plus = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
            public const string Excel2003 = "application/vnd.ms-excel";
            public const string Excel2007Plus = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            public const string Powerpoint2003 = "application/vnd.ms-powerpoint";
            public const string Powerpoint2007Plus = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
        }
